                        ...
                        this.props.array.map((libro) => {
                            ...
                            return (
                                <ListGroup.Item key={libro._id} className="d-flex align-items-center">
                                    ...
                                    <Button onClick={(e) => this.handleClick(e, libro._id)} variant="danger" className="ms-auto"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
